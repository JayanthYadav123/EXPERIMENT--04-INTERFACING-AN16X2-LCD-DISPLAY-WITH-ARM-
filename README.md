...
int main(void)
{
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	  Lcd_cursor(&lcd, 0,1);
	  Lcd_string(&lcd, "JAYANTH\n");
	  HAL_Delay(100);
	  Lcd_cursor(&lcd, 1,0);
	  for(int x=0;x<1;x++)
	  {
		  Lcd_string(1,0);
		  Lcd_string(&lcd, "212221230030");
	   HAL_Delay (200);
...
![WhatsApp Image 2023-10-03 at 09 41 52](https://github.com/JayanthYadav123/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/94836154/cdf29ef0-a525-47e8-bfef-383e6c3977a7)
